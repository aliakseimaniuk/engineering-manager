...
|----------------------|------------------------------------------------|---------------------------------------------------|
| Business Impact      | Financial gains or cost savings              | Revenue, Cost Reduction, Market Share           |
| Technical Health     | Quality and maintainability of the codebase | Bug Count, Test Coverage, Code Complexity        |
| Team Capacity & Velocity | Impact on team’s delivery speed            | Story Points Completed, Cycle Time              |
| Strategic Alignment   | Alignment with company goals                 | Qualitative assessment (High/Medium/Low)         |
| Learning & Innovation | Opportunities for skill development          | Number of new technologies explored, Training Hours |
