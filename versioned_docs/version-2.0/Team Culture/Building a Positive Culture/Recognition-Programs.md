...
3. **Small, Thoughtful Rewards:** Forget the expensive gifts. Consider things like:
...
4. **Document Recognition:** Keep a record of recognition received. This can be invaluable for performance reviews and career development conversations.  Consider a simple spreadsheet, or integrate with your existing HR systems if available. It’s also a nice morale boost for individuals to see a history of positive feedback.
5. **Tie Recognition to Values:**  Actively look for behaviors that align with your team’s core values and explicitly call them out. This reinforces those values and encourages others to embody them.
