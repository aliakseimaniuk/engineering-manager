...
1. **Recall Successes & Failures:** Gather the team (a smaller, representative group is fine to start). Ask: "Think about a time we were *really* successful as a team. What behaviors contributed to that success? Conversely, what behaviors led to a failure or frustration?"
2. **Identify Patterns:** Look for recurring themes. Did people consistently go the extra mile to help each other? Was there a willingness to admit mistakes and learn from them? Did the team prioritize thoroughness over speed, or vice versa?
3. **Phrase as Declarations:** Turn these observed behaviors into concise, declarative statements. Instead of "We value good communication," you might end up with "We prioritize direct, honest feedback, even when it's difficult."
