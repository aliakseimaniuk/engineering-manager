...
For over two decades, I’ve seen engineering teams flourish and flounder. The technical skill is often fairly consistent, but what *consistently* separates the high-performers isn’t just *what* they build, but *how* they build it, and *why*. That “how” and “why” boils down to culture. But culture isn't some fluffy, HR-driven initiative. It’s a living, breathing system built on a foundation of shared values – and those values need to be explicitly defined. I call these definitions “Tenets.”

This isn't about ping pong tables or free snacks. It’s about the fundamental beliefs that guide your team's behavior, decision-making, and interactions. Think of them as the architectural principles for your team’s operating system.
...
Explicit tenets provide:

* **A Shared North Star:**  Everyone understands what's truly important, even when faced with difficult trade-offs.
* **A Framework for Decision-Making:**  Tenets become the lens through which you evaluate options. “Does this align with our tenet of ‘Radical Transparency’?”
* **A Recruiting Filter:** They attract individuals who genuinely resonate with your values.
* **A Basis for Feedback & Growth:**  You can constructively address behaviors that deviate from the team’s core beliefs.

## Crafting Your Team’s Tenets: A Practical Approach

Don't pull these out of thin air. Your tenets should emerge from the collective wisdom of your team. Here’s a process I’ve successfully used:

1. **Individual Reflection (30 mins):** Ask each team member to individually brainstorm what they value most in a work environment and how they believe the team should operate. Encourage them to think beyond generic terms like "respect" and focus on *behaviors* that demonstrate those values.
2. **Group Workshop (2-3 hours):** Facilitate a workshop where the team shares their individual reflections. Focus on identifying common themes and areas of strong agreement.  
3. **Refinement & Prioritization:**  Combine similar ideas, refine the language to be clear and concise, and prioritize the top 3-5 tenets. We’ve found that prioritizing 3-5 tenets helps maintain focus and impact.
4. **Living Document:**  Tenets aren’t etched in stone. Revisit them quarterly to ensure they still resonate and accurately reflect the team’s evolving needs.

## Examples of Powerful Tenets (and what they *mean*)
...
Simply *defining* tenets isn’t enough. You need to actively integrate them into your daily workflow. Here are some tactics:
...
Implementing these practices takes time and consistent effort, but the long-term benefits are significant. Building a strong team culture isn’t a quick fix. It’s a continuous process of refinement, reinforcement, and adaptation. Explicit tenets provide the foundation, but it's the daily commitment to living those values that truly makes the difference.
