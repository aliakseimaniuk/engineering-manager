...
1. **Frequency & Anonymity:** I recommend quarterly NPS surveys. Crucially, they *must* be anonymous to encourage honest feedback. However, consider allowing optional, identifiable comments for those who wish to provide more detailed explanations.
2. **The "Why" Question:** Always include an open-ended follow-up question: “What is the primary reason for your score?” This qualitative data is the goldmine.
...
4. **Share Results (Transparency is Key):** Publish the results (overall and segmented) with your team. Be upfront about the good and the bad. This builds trust and demonstrates that you’re genuinely interested in their feedback.
5. **Create Actionable Items:** This is the most important step! Don't let the feedback gather dust. Prioritize the most common themes and create concrete action items. For example:
