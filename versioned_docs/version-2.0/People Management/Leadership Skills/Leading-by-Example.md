...
| Proactive Problem Solving | Identify a small potential issue *before* it becomes a problem and publicly document your approach to resolving it. | Team member may feel undermined if the issue was already known to them. |
| Effective Communication | Over-communicate on a minor update, even if it feels excessive, to model transparency. | Team member may become desensitized to frequent updates. |
