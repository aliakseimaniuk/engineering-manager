...
1. **Identify Desired Behaviors:** Before the change even begins, define the behaviors you want to encourage. This could include things like:
...
4. **Focus on Effort, Not Just Outcome:** Especially during a challenging change, acknowledge the effort people are putting in, even if the results aren’t perfect yet. ("I know this new testing framework is a steep learning curve, but I'm impressed with your dedication to mastering it.")

5. **Small Wins Matter:** Celebrate even the smallest accomplishments. A successful code review, a resolved bug, a helpful piece of documentation – these are all opportunities to reinforce positive behavior. Recognizing these incremental steps keeps morale high and builds momentum.
