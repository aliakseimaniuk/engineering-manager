...
3. **Knowledge Capture & Dissemination:** This is where many programs fall apart. Someone attends a great workshop… and the knowledge sits with them. Implement systems to capture and share that knowledge:
...
4. **Measure & Iterate:** Don’t assume the program is working. Track:
