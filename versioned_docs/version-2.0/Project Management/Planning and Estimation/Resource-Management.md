...
| Engineer | Frontend (React) | Backend (Node.js) | Database (PostgreSQL) | DevOps (AWS) |
|---|---|---|---|---|
| Alice | Expert | Intermediate | Beginner | Intermediate |
| Bob | Intermediate | Expert | Intermediate | Beginner |
| Charlie | Beginner | Intermediate | Expert | Intermediate |
