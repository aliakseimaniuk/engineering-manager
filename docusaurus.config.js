...
const config = {
  ...
  tagline: 'Engineering Management is cool',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://aliakseimaniuk.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/engineering-manager/',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/aliakseimaniuk/engineering-manager',
        },
        theme: {
